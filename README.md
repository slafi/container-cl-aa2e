...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-cl-aa2e.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-cl-aa2e.containers.anotherwebservice.com/
...
```
git clone git@github.com:slafi/container-cl-aa2e.git
cd container-cl-aa2e
```
...
```
docker attach container-cl-aa2e
```
